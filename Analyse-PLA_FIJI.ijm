...
run("Analyze Particles...", "size=0.001-0.01 display");
...
run("Analyze Particles...", "size=0.1-1000 add exclude show=Masks");
...
run("Invert");
run("Analyze Particles...", "size=0.1-1000 add show=Masks");
roiManager("select all");
roiManager("combine");
run("Make Inverse");
roiManager("add");
...
run("Analyze Particles...", "size=0.001-0.01 add display");
selectWindow("Results");
